...
public final class MainScreen extends javax.swing.JFrame {
    ...
    // Método Contrustor dessas Classes ( Chamar o método nessa classe para inicialização)
    public MainScreen() {
        ...
        jPanelTasksLayout.setVerticalGroup(
            ...
            .addGroup(jPanelTasksLayout.createSequentialGroup()
                .addGroup(jPanelTasksLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jLabelTasksTitle, javax.swing.GroupLayout.PREFERRED_SIZE, 25, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(jLabelTasksAdd))
        ...
        jPanelEmptyListLayout.setHorizontalGroup(
            ...
            .addGroup(jPanelEmptyListLayout.createSequentialGroup()
                ...
                .addGroup(jPanelEmptyListLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(jLabelEmptyListSubTitle, javax.swing.GroupLayout.DEFAULT_SIZE, 365, Short.MAX_VALUE))
                .addContainerGap())
        );
    ...
    private void jLabelProjectsAddMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabelProjectsAddMouseClicked
        ...
        //ProjectDialogScreen projectDialogScreen = new ProjectDialogScreen(this, rootPain)
        ProjectDialogScreen projectDialogScreen = new ProjectDialogScreen(this, rootPaneCheckingEnabled);
        projectDialogScreen.setVisible(true);

        //                 (ouvinte da janela)estou intânciando aqui o objeto
        projectDialogScreen.addWindowListener(new WindowAdapter() {
            // Quando a janela de abaixo for fechada, esse evento e disparado!
            @Override
    ...
    private void jLabelTasksAddMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabelTasksAddMouseClicked
        ...
        // Esse metódo retorna ao índice do item selecionado
    ...
    // Instanciar as duas variáveis criadas lá em cima
    ...
    public void initComponetsModel() {
        ...
        if(!projectsModel.isEmpty()){
            // Metódo para a lista de projetos sempre terá um intem selecionado
    ...
    public void loadTasks(int idProject) {
        ...
        // Transfomou-se no método(isEmpty() que diz que a lista não(! Negação) está vazia

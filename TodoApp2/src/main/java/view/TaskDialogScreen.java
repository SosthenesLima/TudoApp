...
public class TaskDialogScreen extends javax.swing.JDialog {
    ...
    //Variável Global do tipo Projeto ( Que é o Projeto ao qual a Tarefa pertece!)
    Project project;
    ...
    private void initComponents() {
        ...
        jLabelDescption = new javax.swing.JLabel();
        jTextAreaDescription = new javax.swing.JTextField();
        ...
        jLabelDescption.setText("Descrição");

        jTextAreaDescription.setHorizontalAlignment(javax.swing.JTextField.LEFT);
        jTextAreaDescription.setToolTipText("");
        jTextAreaDescription.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jTextAreaDescriptionActionPerformed(evt);
            }
        });
                ...
                .addGroup(jPanelTaskLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanelTaskLayout.createSequentialGroup()
                        .addGroup(jPanelTaskLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                            ...
                            .addComponent(jScrollPaneNotes, javax.swing.GroupLayout.DEFAULT_SIZE, 407, Short.MAX_VALUE)
                            ...
                            .addComponent(jLabelDescption, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                            .addComponent(jTextAreaDescription, javax.swing.GroupLayout.Alignment.LEADING)
        ...
        jPanelTaskLayout.setVerticalGroup(
            ...
            .addGroup(jPanelTaskLayout.createSequentialGroup()
                ...
                .addGap(2, 2, 2)
                .addComponent(jLabelDescption)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(jTextAreaDescription, javax.swing.GroupLayout.PREFERRED_SIZE, 74, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(18, 18, 18)
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(jScrollPaneNotes, javax.swing.GroupLayout.DEFAULT_SIZE, 158, Short.MAX_VALUE)
                .addContainerGap())
        );
    ...
    private void jLabelToolBarSaveMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabelToolBarSaveMouseClicked
        ...
        try {
            // Poderia usar o operador || ( SEM A NEGAÇÃO !)
            //if (!jTextFieldName.getText().isEmpty() && !jFormattedTextFieldDeadline.getText().isEmpty()){
               //JOptionPane.showMessageDialog(rootPane, "A Tarefa não salva! pois existem campos obrigatórios a serem preechidos!");
             if(isFieldsValid()){
                 Task task = new Task();
        
                // O ID dessa tarefa ao qual esse Projeto pertece, vai ser modificado pro IdProjeto
        ...
        this.dispose();
               ...
               //JOptionPane.showMessageDialog(rootPane, "a Tarefa não foi salva! pois existem campos obrigatórios a serem preechidos!"); 
    ...
    private void jTextAreaDescriptionActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jTextAreaDescriptionActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_jTextAreaDescriptionActionPerformed
    ...
    private javax.swing.JLabel jLabelDescption;
    ...
    private javax.swing.JTextField jTextAreaDescription;
